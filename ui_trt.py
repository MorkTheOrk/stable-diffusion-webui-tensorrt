...
def on_ui_tabs():
    with gr.Blocks(analytics_enabled=False) as trt_interface:
        ...
        button_export_preset_trt.click(
            ...
            inputs=[trt_filename, trt_source_filename_preset, profile_512_512_1, profile_512_512_4, profile_768x768x1, profile_768x768x4, use_fp16],
            outputs=[trt_result, trt_info],      
        )
